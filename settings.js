...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=qENUTCQA#fwd9LAUxFuA8VB5PUtGCaR7VtTTHWYuKkvTc-Uzsrn8' : process.env.SESSION_ID,
...
MAX_SIZE: 500, 
ALIVE:  process.env.ALIVE  || '🍀𝙃𝙀𝙇𝙇𝙊 𝙄𝘼𝙈 𝘼𝙇𝙄𝙑𝙀 𝙉𝙊𝙒 𝙐𝙎𝙀 𝙁𝙊𝙍 𝙈𝙀𝙉𝙐 𝘾𝙊𝙈𝙈𝘼𝙉𝘿✔️'  ,    
